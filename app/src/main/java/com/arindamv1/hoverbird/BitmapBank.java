...
public class BitmapBank {
    ...
    public BitmapBank(Resources res) {
        ...
        tubeTop = BitmapFactory.decodeResource(res, R.drawable.tube_top_new);
        tubeBottom = BitmapFactory.decodeResource(res, R.drawable.tube_bottom_new);
    ...
    public Bitmap scaleImage(Bitmap bitmap){
        ...
        We'll multiply widthHeightRation with screenHeight to get scaled width of the bitmap.
        then call createScaledBitmap() to create a new bitmap, scaled from an existing bitmap, when possible

         */

        int backgroundScaledWidth = (int) widthHeightRation * AppConstants.SCREEN_HEIGHT;
